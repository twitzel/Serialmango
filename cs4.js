...
exports.websocketDataIn = function(dataSocket, Socket){
    ...
    if(dataSocket.Type){
        ...
        else if(dataSocket.Type == "COPYTOPUBLIC")
        {
            ...
            sendOutput(dataToSend) ;//  setTimeout(sendOutput, 1000, dataToSend); //setTimeout(function(){sendOutput(dataToSend);}, 3000);
            ...
            sendOutput(dataToSend) ;//var a = setTimeout(sendOutput, 2000, dataToSend); //setTimeout(function(){sendOutput(dataToSend);}, 6000);  // sendOutput(dataToSend);
            comlib.websocketsend("Sent MIDIFIL1");
            ...
            setTimeout(sendOutput, 3000, dataToSend); //setTimeout(function(){sendOutput(dataToSend);}, 9000);  //sendOutput(dataToSend);
            ...
            setTimeout(sendOutput, 4000, dataToSend);//sendOutput(dataToSend);
            ...
            setTimeout(sendOutput, 5000, dataToSend);//sendOutput(dataToSend);
...
exports.getSettings = function(){
    ...
    collectionSettings.findOne({},function(error,result){
        ...
        comlib.websocketsend("Successfully updated settings file");
        dataToSend = '          SLAVE ZIGEN ' + cs4Settings.enableZigbee2 ; //update the DMX channels
        setTimeout(function(){sendOutput(dataToSend);}, 3000);
        dataToSend = '          MIDIFIL1 ' + cs4Settings.midisex1 + " " + cs4Settings.nonsysex1 + " "+ (parseInt(+cs4Settings.deviceIDLow1)*1 + parseInt(+cs4Settings.deviceIDHigh1)*16).toString() + " " + cs4Settings.type1 + " " + cs4Settings.commandformat1 + " " +   cs4Settings.command1 + " " + cs4Settings.nonsysextype1 + " " + cs4Settings.nonsysexchannel1 + " ";
